...
void GUIRenderer::renderXpBar(SDL_Renderer* renderer, Player* player, int screenWidth, int screenHeight) {
    // carrega UI
    ...
    const int progressBarHeight = 20; // altura da XPBAR

    //Calcula o widht da barra de xp, com diferença para esquerda e direita offsets
